...
import img1 from '/images2/new/content.webp';
...
function About3(props) {
    ...
    const [dataBlock] = useState(
        {
            subheading: 'Editorial Wing',
            heading: 'Prakaran',
            desc1: '"With quill as our wand, we weave symphonies of eloquence"' ,
            desc2 : 'Enter Prakaran, the sanctum where words are spun into tales of enchantment. Our emblem, a poised quill above an open manuscript, invokes the essence of stories, inviting readers to explore the realms of imagination.'
        }
    )
    return (
