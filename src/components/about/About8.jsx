...
import img1 from '../../assets/images/new/Sampreshan.webp';
                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="about__left">
                                <div className="block-text" >
                                    <h6 className="sub-heading2"><span>{dataBlock.subheading}</span></h6>
                                    <h3 className="heading2">{dataBlock.heading}</h3>
