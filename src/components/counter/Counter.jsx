/*
Section is getting used in the Home Section of the website
*/
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="couter__main">
                                    <div className="couter-list spacel">
                                        <div className="couter-box">
                                            ...
                                            <h4 className="numb">1500+</h4>
                                            <p>Participation in our events</p>
                                        </div>
                                        <div className="couter-box">
                                            <div className="icon">
                                            ...
                                            <h4 className="numb">10000+</h4>
                                            <p>Our reach including associated reach</p>
                                        </div>
                                        <div className="couter-box">
                                            <div className="icon">
                                                <svg width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h4 className="numb">9000+</h4>
                                            <p>Youths engaged in Samarth Activities</p>
                                        </div>
