              ...
              <div className="page-title__main">
                ...
                {/* <div className="bottom">
                  ...
                  <ul className="list-social">
                    <li>
                      <a href="https://www.facebook.com/SamarthTMSL">
                        <svg
                          width="9"
                          height="16"
                          viewBox="0 0 9 16"
                    ...
                    <li>
                      <a href="https://twitter.com/Samarth_tmsl">
                        <svg
                          width="15"
                          height="12"
                          viewBox="0 0 15 12"
                    ...
                    <li>
                      <a href="https://www.linkedin.com/company/samarthtmsl/mycompany/">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 14 14"
                    ...
                    <li>
                      <a href="https://www.youtube.com/@samarth_tmsl_official">
                        <svg
                          width="18"
                          height="12"
                          viewBox="0 0 18 12"
